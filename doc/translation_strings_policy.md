...
This document provides guidelines for internationalization of the EOX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eox_en.ts` remains unchanged.
