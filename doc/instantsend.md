...
This mechanism has been integrated into Bitcore-Node-EOX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eoxpay/insight-api-eox#web-socket-api](https://github.com/eoxpay/insight-api-eox#web-socket-api)
* API: [https://github.com/eoxpay/insight-api-eox#instantsend-transactions](https://github.com/eoxpay/insight-api-eox#instantsend-transactions)
...
By default, the EOX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EOX Core daemon:
