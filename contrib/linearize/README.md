# Linearize
Construct a linear, no-fork, best version of the EOX blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install eox_hash

https://github.com/eoxpay/eox_hash
...
JSON-RPC server. Running `eoxd` or `eox-qt -server` will be sufficient.
...
* `input`: eoxd blocks/ directory containing blkNNNNN.dat
