    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EOX-light"), QVariant("light"));
    ui->theme->addItem(QString("EOX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EOX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("EOX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("EOX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EOX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EOX-traditional"), QVariant("trad"));
