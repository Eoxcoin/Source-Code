    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  eox-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the EOX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EOX, 0.1 EOX, 1 EOX and 10 EOX -- sort of like the paper money you use every day.</li> \
