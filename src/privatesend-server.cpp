...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all EOX related functionality
...
/*
    ...
    allow endless transaction that would bloat EOX and make it unusable. To
