...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print EOX address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "eox",               "masternode",             &masternode,             true,  {} },
    { "eox",               "masternodelist",         &masternodelist,         true,  {} },
    { "eox",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "eox",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "eox",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "eox",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
